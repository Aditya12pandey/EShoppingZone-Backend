...
namespace EShoppingZone.Order.API.Tests
{
    ...
    public class OrderServiceTests
    {
        ...
        public void Setup()
        {
            ...
            // Provide Razorpay keys so InitiateOnlinePayment / VerifyAndPlaceOrder don't throw on config lookup
            ...
            _orderService = new OrderService(_context, _mockRepo.Object, _mockHttpClientFactory.Object, _mockConfiguration.Object);
        }
